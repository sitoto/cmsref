      ...
      describe "products" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:product, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:product, :title => "A title") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:product, :title => "UniqueTitleOne") }
